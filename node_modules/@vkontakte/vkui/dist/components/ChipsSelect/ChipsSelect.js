...
var ChipsSelect = function ChipsSelect(props) {
  ...
  var chipsSelectOptions = useRef([]).current;
  ...
  return createScopedElement("div", {
    ...
    after: createScopedElement(Icon20Dropdown, null)
    ...
    size: "small"
  })) : createScopedElement(Fragment, null, showCreatable && createScopedElement(CustomSelectOption, {
    hovered: focusedOptionIndex === 0,
    onMouseDown: addOptionFromInput,
    onMouseEnter: function onMouseEnter() {
      return setFocusedOptionIndex(0);
    }
  }, creatableText), !(filteredOptions === null || filteredOptions === void 0 ? void 0 : filteredOptions.length) && !showCreatable && emptyText ? createScopedElement(Caption, {
    level: "1",
    weight: "regular",
