...
var ViewInfinite = /*#__PURE__*/function (_Component) {
  _inherits(ViewInfinite, _Component);
  ...
  function ViewInfinite(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "transitionEndHandler", function (e) {
      if (!e || ['vkui-animation-ios-next-forward', 'vkui-animation-ios-prev-back', 'vkui-animation-view-next-forward', 'vkui-animation-view-prev-back'].includes(e.animationName)) {
        ...
        var prevPanelScrolls = _toConsumableArray(_this.state.scrolls[prevPanel] || []).slice(0, -1);

        var newPanelScrolls = _toConsumableArray(_this.state.scrolls[activePanel] || []);

        var scrollPosition = isBack ? newPanelScrolls.pop() : 0;
        var scrolls = isBack ? _objectSpread(_objectSpread({}, _this.state.scrolls || {}), {}, (_objectSpread2 = {}, _defineProperty(_objectSpread2, prevPanel, prevPanelScrolls), _defineProperty(_objectSpread2, activePanel, newPanelScrolls), _objectSpread2)) : _this.state.scrolls;
    ...
    _defineProperty(_assertThisInitialized(_this), "onMoveX", function (e) {
      ...
      if (platform === IOS && configProvider.isWebView && _this.props.onSwipeBack) {
        ...
        if (e.startX <= 70 && !_this.state.swipingBack && _this.props.history.length > 1) {
          ...
          var scrolls = _objectSpread(_objectSpread({}, _this.state.scrolls), {}, _defineProperty({}, _this.state.activePanel, [].concat(_toConsumableArray(prevScrolls), [_this.props.scroll.getScroll().y])));
  ...
  _createClass(ViewInfinite, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.activePanel !== this.props.activePanel && !prevState.swipingBack && !prevState.browserSwipe) {
        ...
        var _scrolls = _objectSpread(_objectSpread({}, prevState.scrolls), {}, _defineProperty({}, prevProps.activePanel, [].concat(_toConsumableArray(prevScrolls), [this.props.scroll.getScroll().y])));
      ...
      if (prevProps.activePanel !== this.props.activePanel && prevState.swipingBack) {
        ...
        var prevPanelScrolls = _toConsumableArray(prevState.scrolls[prevPanel] || []).slice(0, -1);

        var newPanelScrolls = _toConsumableArray(prevState.scrolls[nextPanel] || []);

        var scrollPosition = newPanelScrolls.pop();

        var newScrolls = _objectSpread(_objectSpread({}, prevState.scrolls || {}), {}, (_objectSpread5 = {}, _defineProperty(_objectSpread5, nextPanel, newPanelScrolls), _defineProperty(_objectSpread5, prevPanel, prevPanelScrolls), _objectSpread5));
      ...
      if (prevState.swipeBackResult === SwipeBackResults.fail && !this.state.swipeBackResult) {
        var _newPanelScrolls = _toConsumableArray(scrolls[this.state.activePanel] || []);

        var _scrollPosition = _newPanelScrolls.pop();

        var _newScrolls = _objectSpread(_objectSpread({}, scrolls), {}, _defineProperty({}, this.state.activePanel, _newPanelScrolls));
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props2, ["popout", "modal", "platform", "activePanel", "splitCol", "configProvider", "history", "id", "nav", "onTransition", "onSwipeBack", "onSwipeBackStart", "onSwipeBackCancel", "window", "document", "scroll", "isBackCheck"]);
