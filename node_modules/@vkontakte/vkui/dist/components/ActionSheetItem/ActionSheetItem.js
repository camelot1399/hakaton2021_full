...
var ActionSheetItem = function ActionSheetItem(_ref) {
  ...
  return createScopedElement(Tappable, _extends({}, restProps, {
    ...
    vkuiClass: classNames(getClassName('ActionSheetItem', platform), "ActionSheetItem--".concat(mode), (_classNames = {
      'ActionSheetItem--compact': isCompact,
      'ActionSheetItem--desktop': isDesktop
    }, _defineProperty(_classNames, "ActionSheetItem--sizeY-".concat(sizeY), sizeY === SizeType.COMPACT), _defineProperty(_classNames, 'ActionSheetItem--withSubtitle', hasReactNode(subtitle)), _classNames)),
    Component: Component
