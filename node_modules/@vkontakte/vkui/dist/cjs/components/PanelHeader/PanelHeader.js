...
var PanelHeader = function PanelHeader(props) {
  var left = props.left,
      ...
      sizeY = props.sizeY,
      fixed = props.fixed,
      restProps = (0, _objectWithoutProperties2.default)(props, ["left", "children", "right", "separator", "visor", "transparent", "shadow", "getRef", "getRootRef", "sizeX", "sizeY", "fixed"]);
  var platform = (0, _usePlatform.usePlatform)();

  var _useContext2 = (0, _react.useContext)(_ConfigProviderContext.ConfigProviderContext),
