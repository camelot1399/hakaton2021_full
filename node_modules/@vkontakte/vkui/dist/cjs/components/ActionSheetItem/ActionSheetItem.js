...
var ActionSheetItem = function ActionSheetItem(_ref) {
  ...
  var children = _ref.children,
      ...
      sizeY = _ref.sizeY,
      restProps = (0, _objectWithoutProperties2.default)(_ref, ["children", "autoclose", "mode", "meta", "subtitle", "before", "selectable", "value", "name", "checked", "defaultChecked", "onChange", "onClick", "sizeY"]);
  var platform = (0, _usePlatform.usePlatform)();

  var _useContext = (0, _react.useContext)(_ActionSheetContext.ActionSheetContext),
  ...
  return (0, _jsxRuntime.createScopedElement)(_Tappable.default, (0, _extends2.default)({}, restProps, {
    ...
    vkuiClass: (0, _classNames2.classNames)((0, _getClassName.getClassName)('ActionSheetItem', platform), "ActionSheetItem--".concat(mode), (_classNames = {
      'ActionSheetItem--compact': isCompact,
      'ActionSheetItem--desktop': isDesktop
    }, (0, _defineProperty2.default)(_classNames, "ActionSheetItem--sizeY-".concat(sizeY), sizeY === _withAdaptivity.SizeType.COMPACT), (0, _defineProperty2.default)(_classNames, 'ActionSheetItem--withSubtitle', (0, _utils.hasReactNode)(subtitle)), _classNames)),
    Component: Component
  ...
  }, sizeY === _withAdaptivity.SizeType.COMPACT ? (0, _jsxRuntime.createScopedElement)(_react.Fragment, null, (0, _jsxRuntime.createScopedElement)(_Text.default, {
  ...
  }, meta)) : (0, _jsxRuntime.createScopedElement)(_react.Fragment, null, (0, _jsxRuntime.createScopedElement)(_Title.default, {
    weight: mode === 'cancel' ? 'medium' : 'regular',
