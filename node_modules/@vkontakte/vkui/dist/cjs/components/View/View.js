      ...
      if (platform === _platform.IOS && configProvider.isWebView && _this.props.onSwipeBack) {
        ...
        if (e.startX <= 70 && !_this.state.swipingBack && _this.props.history.length > 1) {
          _this.setState({
            ...
            scrolls: _objectSpread(_objectSpread({}, _this.state.scrolls), {}, (0, _defineProperty2.default)({}, _this.state.activePanel, _this.props.scroll.getScroll().y))
          });
        }
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.activePanel !== this.props.activePanel && !prevState.swipingBack && !prevState.browserSwipe) {
        ...
        this.setState({
          ...
          activePanel: null,
          animated: true,
          scrolls: _objectSpread(_objectSpread({}, prevState.scrolls), {}, (0, _defineProperty2.default)({}, prevProps.activePanel, this.props.scroll.getScroll().y)),
          isBack: isBack
        });
