  ...
  function ViewInfinite(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "transitionEndHandler", function (e) {
      if (!e || ['vkui-animation-ios-next-forward', 'vkui-animation-ios-prev-back', 'vkui-animation-view-next-forward', 'vkui-animation-view-prev-back'].includes(e.animationName)) {
        ...
        var scrolls = isBack ? _objectSpread(_objectSpread({}, _this.state.scrolls || {}), {}, (_objectSpread2 = {}, (0, _defineProperty2.default)(_objectSpread2, prevPanel, prevPanelScrolls), (0, _defineProperty2.default)(_objectSpread2, activePanel, newPanelScrolls), _objectSpread2)) : _this.state.scrolls;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onMoveX", function (e) {
      ...
      if (platform === _platform.IOS && configProvider.isWebView && _this.props.onSwipeBack) {
        ...
        if (e.startX <= 70 && !_this.state.swipingBack && _this.props.history.length > 1) {
          ...
          var scrolls = _objectSpread(_objectSpread({}, _this.state.scrolls), {}, (0, _defineProperty2.default)({}, _this.state.activePanel, [].concat((0, _toConsumableArray2.default)(prevScrolls), [_this.props.scroll.getScroll().y])));
  ...
  (0, _createClass2.default)(ViewInfinite, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.activePanel !== this.props.activePanel && !prevState.swipingBack && !prevState.browserSwipe) {
        ...
        var _scrolls = _objectSpread(_objectSpread({}, prevState.scrolls), {}, (0, _defineProperty2.default)({}, prevProps.activePanel, [].concat((0, _toConsumableArray2.default)(prevScrolls), [this.props.scroll.getScroll().y])));
      ...
      if (prevProps.activePanel !== this.props.activePanel && prevState.swipingBack) {
        ...
        var newScrolls = _objectSpread(_objectSpread({}, prevState.scrolls || {}), {}, (_objectSpread5 = {}, (0, _defineProperty2.default)(_objectSpread5, nextPanel, newPanelScrolls), (0, _defineProperty2.default)(_objectSpread5, prevPanel, prevPanelScrolls), _objectSpread5));
      ...
      if (prevState.swipeBackResult === SwipeBackResults.fail && !this.state.swipeBackResult) {
        ...
        var _newScrolls = _objectSpread(_objectSpread({}, scrolls), {}, (0, _defineProperty2.default)({}, this.state.activePanel, _newPanelScrolls));
